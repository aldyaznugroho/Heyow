 ...
 */
public class NearMeTabFragment extends BaseFragment implements NearMeMvpView {

    @Inject
    NearMeMvpPresenter<NearMeMvpView> presenter;

    @BindView(R.id.near_me_swipe_refresh) SwipeRefreshLayout swipeRefresh;
    @BindView(R.id.near_me_recycler_view) RecyclerView recyclerView;
    @BindView(R.id.state_layout) MainStateLayout stateLayout;

    CustomRecyclerAdapter<MatchDetailResponse> nearMeListAdapter;

    public static NearMeTabFragment getInstance() {
        return new NearMeTabFragment();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_near_me_tab, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        presenter.loadNearMeApiService();
    }
    ...
    public void bindDataToRecyclerView(List<MatchDetailResponse> matchList) {
        nearMeListAdapter = new CustomRecyclerAdapter<>(
                getContext(),
...
//                        String city = matchLocation.substring(beforeLastComma + 1, afterLastComma).trim();
        ...
        recyclerView.setAdapter(nearMeListAdapter);
    }
    ...
    @Override
    public boolean isDataLoadToView(boolean isDataLoad) {
        return isDataLoad;
    }
}