...
public class CreatedMatchActivity extends BaseActivity implements CreatedMatchMvpView {
    @Inject CreatedMatchMvpPresenter<CreatedMatchMvpView> presenter;

    @BindView(R.id.created_match_toolbar) Toolbar toolbar;
    @BindView(R.id.created_match_swipe_refresh) SwipeRefreshLayout swipeRefresh;
    @BindView(R.id.created_match_recycler_view) RecyclerView recyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_created_match);
        ...
        setTitle(getString(R.string.created_match));
        init();
    }
