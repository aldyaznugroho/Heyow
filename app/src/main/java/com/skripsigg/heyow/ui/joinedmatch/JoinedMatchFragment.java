 ...
 */
public class JoinedMatchFragment extends BaseFragment implements JoinedMatchMvpFragmentView {

    @Inject JoinedMatchMvpFragmentPresenter<JoinedMatchMvpFragmentView> presenter;

    @BindView(R.id.state_layout)
    MainStateLayout stateLayout;
    @BindView(R.id.fragment_joined_recycler_view) RecyclerView recyclerView;

    private CustomRecyclerAdapter<MatchDetailResponse> joinedMatchListAdapter;
    private boolean isDataLoad = false;

    public static JoinedMatchFragment getInstance() {
        return new JoinedMatchFragment();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_joined_match_tab, container, false);
    ...
    public void bindDataToRecyclerView(List<MatchDetailResponse> matchList) {
        joinedMatchListAdapter = new CustomRecyclerAdapter<>(
                getContext(),
        ...
        recyclerView.setAdapter(joinedMatchListAdapter);
    }
